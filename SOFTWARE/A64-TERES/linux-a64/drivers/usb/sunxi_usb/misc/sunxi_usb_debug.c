...
void print_usb_reg_by_ep(spinlock_t *lock, void __iomem *usbc_base, __s32 ep_index, char *str)
{
...
void print_all_usb_reg(spinlock_t *lock, void __iomem *usbc_base, __s32 ep_start, __u32 ep_end, char *str)
{
	__u32 i = 0;
	__u32 old_ep_index = 0;
