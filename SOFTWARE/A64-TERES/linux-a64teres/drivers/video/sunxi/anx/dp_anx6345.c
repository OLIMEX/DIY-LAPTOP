...
static int edp_reg_show(struct seq_file *s, void *v)
{
	...
	if(!anx6345)
	{
		printk(KERN_INFO "eDP device not found!\n",__func__);
		return 0;
	}
...
static int anx980x_aux_dpcdread_bytes(struct i2c_client *client,unsigned long addr, char cCount,char* pBuf)
{
	...
	for(i =0;i<cCount;i++)
	{
		...
		printk("DP_TX_BUF_DATA_0_REG+i c = %.2x\n",val);
		*(pBuf+i) = val;
...
static int anx980x_init(struct i2c_client *client)
{
	...
	{
		printk(KERN_INFO "pclk not stable!\n",__func__);
	}
...
anx6345_i2c_write_p1_reg(0x72, SP_TX_TOTAL_LINEL_REG, 0x28);//SP_TX_TOTAL_LINEL_REG
anx6345_i2c_write_p1_reg(0x72, SP_TX_TOTAL_LINEH_REG, 0x03);
anx6345_i2c_write_p1_reg(0x72, SP_TX_ACT_LINEL_REG, 0x00);
anx6345_i2c_write_p1_reg(0x72, SP_TX_ACT_LINEH_REG, 0x03);
anx6345_i2c_write_p1_reg(0x72, SP_TX_VF_PORCH_REG, 0x14);
anx6345_i2c_write_p1_reg(0x72, SP_TX_VSYNC_CFG_REG, 0x04);
anx6345_i2c_write_p1_reg(0x72, SP_TX_VB_PORCH_REG, 0x10);
anx6345_i2c_write_p1_reg(0x72, SP_TX_TOTAL_PIXELL_REG, 0x38);
anx6345_i2c_write_p1_reg(0x72, SP_TX_TOTAL_PIXELH_REG, 0x06);
anx6345_i2c_write_p1_reg(0x72, SP_TX_ACT_PIXELL_REG, 0x56);
anx6345_i2c_write_p1_reg(0x72, SP_TX_ACT_PIXELH_REG, 0x05);
anx6345_i2c_write_p1_reg(0x72, SP_TX_HF_PORCHL_REG, 0x31);
anx6345_i2c_write_p1_reg(0x72, SP_TX_HF_PORCHH_REG, 0x00);
anx6345_i2c_write_p1_reg(0x72, SP_TX_HSYNC_CFGL_REG, 0x10);
anx6345_i2c_write_p1_reg(0x72, SP_TX_HSYNC_CFGH_REG, 0x00);
anx6345_i2c_write_p1_reg(0x72, SP_TX_HB_PORCHL_REG, 0xA1);
anx6345_i2c_write_p1_reg(0x72, SP_TX_HB_PORCHH_REG, 0x00);
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Mitko Gamishev");
MODULE_DESCRIPTION("anx6345 test");
