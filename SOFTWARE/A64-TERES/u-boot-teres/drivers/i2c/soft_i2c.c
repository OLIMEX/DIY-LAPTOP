...
# ifndef I2C_READ
#  define I2C_READ gpio_read_one_pin_value(CONFIG_SOFT_I2C_GPIO_SDA,0)
# endif
...
#  define I2C_SDA(bit) \
	do { \
		if (bit) \
			gpio_set_one_pin_io_status(CONFIG_SOFT_I2C_GPIO_SDA,0,0); \
		else \
			gpio_set_one_pin_io_status(CONFIG_SOFT_I2C_GPIO_SDA, 1,0); \
		I2C_GPIO_SYNC; \
	} while (0)
# endif
...
#  define I2C_SCL(bit) \
	do { \
		gpio_write_one_pin_value(CONFIG_SOFT_I2C_GPIO_SCL, bit,0); \
		I2C_GPIO_SYNC; \
	} while (0)
# endif
